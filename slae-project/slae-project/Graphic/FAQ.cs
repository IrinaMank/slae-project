    ...
    public partial class FAQ : Form
    {
        ...
        void Wrapped_Changer()
        {
            ...
            label3.Text = "Краткая информация по элементам интерфейса, \r\n" +
                ...
                "\r\n" +
                "1) 'Размер ячейки' регулирует размер шрифта текста, вследствие\r\n" +
                ...
                "Возле зеленного целеуказателя указаны I -столбец, J- строка, Х-значение ячейки\r\n" +
                "\r\n" +
                ...
                "\r\n" +
                "6) 'Телепортер', позволяет переместится к указанной ячейке; \r\n" +
                "номера матриц указаны слева от их названий;\r\n" +
                "область допустимых строк и столбцов в данном окне указываются при выборе\r\n" +
                "определенной матрицы; при включенном целеуказателе, укажет на ячейку.\r\n";
            ...
            label5.Text = "7) 'Обновить и показать' основную отображаемую информацию, а именно матрицу А,\r\n" +
                ...
                " экрана, вернуться на ваше местоположение и сбросить настройки на\r\n" +
                " \"по умолчанию\"\r\n" +
                "\r\n" +
                ...
                "Внимание, повторно загруженным элементам выделяется память в плотном формате.";
            ...
            label7.Text = "10) Справка. Вы здесь\r\n" +
                ...
                "\r\n" +
                "16) Вектор невязки для итерационых способов решения\r\n" +
                ...
                "При нажатии правой кнопкой мыши на ячейку появится табличка, указывающая\r\n" +
